const sendemail = (namevisitor ,emailvisitor , attachedMessage) =>{
    return (
    `
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <h1 ass="text-primary" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">Sender: ${namevisitor}</h1>
                                            <p class="text-primary" style="line-height: 24px; font-size: 16px; color: #0d6efd; width: 100%; margin: 0;" align="left">Email sender: ${emailvisitor}</p>
                                            ...
                                            <div class="space-y-3">
                                              <p class="text-gray-700" style="line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;" align="left">message: ${attachedMessage}</p>
                                            </div>
                                          </td>
                                        </tr>
                                      </tbody>
